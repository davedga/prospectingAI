...
- Question bank, when a question is used — the default is a direct question tying the brand and Q4 timing together, varied so it doesn't read identically every time. This is the only thing seniority should change — same structure and tone either way, just this one line:
  - First-touch default: "Is scaling [Company] on TikTok Shop ahead of Q4 a priority for the team?"
  - Later touches / alternate phrasing: "Is TikTok Shop a priority for the team going into the holiday season?" or "Is TikTok Shop a priority for the team going into Q4?"
  - Economic buyer (founder/exec), can tie it to "you" instead of "the team": "Is scaling [Company] on TikTok Shop ahead of Q4 a priority for you?"
...
2. Category + observation, one sentence: "Ahead of Q4, I've been looking closely at the [category] category and noticed [Company] [observation]." ${getSeasonalFramingInstruction()} The observation MUST match their actual TikTok Shop status (given below):
   ...
   - Already on TikTok Shop with real, specific traction in the record (real follower count, units sold, or similar from actual research — never invented): name that specific proof point plainly, e.g. "...noticed [Company] already has real traction on TikTok Shop, [specific real detail]."
