...
4. The thesis and the walk-through offer, combined into ONE sentence, not two — e.g. "Going into Q4, I think [Company] has a real opportunity to [establish itself in this category / scale its existing TikTok Shop presence further, whichever matches their real status], and I'd love the opportunity to walk you through how we envision doing that." When referring back to a category already named in step 2, say "this category," not "a category." Never invent the thesis if their status doesn't clearly support one.
...
2. One confidence-statement sentence starting "We're confident..." (never "We feel confident"), matched to their actual TikTok Shop status, avoiding "lay the foundation" and avoiding reusing "momentum" (already used elsewhere in the sequence):
...
3. One question from the question bank above, matched to their TikTok Shop status (not on TTS: the "going into the holiday season" variant; already on TTS: the "scaling further... been considering" or "is this currently a priority for..." variant) — never the generic "is TikTok Shop a priority" question for a brand that's already live there.`;
